...
public boolean delete(E item)
  ...
  {
	  Node<E> ptr = this.head, temp = null, most = null;
	  int counter = 0, decidingcounter = 0, morethanonecounter = 0;
	  MyLinkedList ModeList = new MyLinkedList();
	  ...
	  if(counter == 1 && decidingcounter == 1)
		  return null;
	  else
	  {
		  ptr = head;
		  while(ptr!=null)
		  {
			  ...
			  if (morethanonecounter == counter)
			  {
				  if (ModeList.isMember(temp.element))
					  continue;
				  else
					  ModeList.append(temp.element);
			  }
			  ptr = temp;
			  ptr = ptr.next;
		  }
